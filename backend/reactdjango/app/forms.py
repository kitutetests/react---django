...
class HouseRentForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['size','apartment_name','location','pin_location','features','photos','video','price','deposit','water_fee','garbage_fee','landlord_contact','caretaker_contact','agent_name','agent_contact','id_photo_front','id_photo_back']
...
class SellPropertyForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['property_type','features','location','pin_location','photos','video','price','payment_process','contact','id_photo_front','id_photo_back']
        widgets = {'pin_location': forms.TextInput(attrs={'placeholder': '(optional)'}),
